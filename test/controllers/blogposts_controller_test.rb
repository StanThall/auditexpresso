...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post blogposts_url, params: { blogpost: { author: @blogpost.author, catchline: @blogpost.catchline, content: @blogpost.content, img_path: @blogpost.img_path, title: @blogpost.title } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { author: @blogpost.author, catchline: @blogpost.catchline, content: @blogpost.content, img_path: @blogpost.img_path, title: @blogpost.title } }
